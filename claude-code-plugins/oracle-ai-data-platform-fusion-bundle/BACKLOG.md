...
### `[ ]` P1.5ε-fix1 — BICC credential preflight (endpoint shape probe + check 6 wiring)
...
### `[ ]` P1.5ε-fix7 — `poll_run` timeout as a CLI flag + longer default
...
### `[ ]` P1.5ε-fix8 — Partial-progress diagnose-on-timeout for `DispatchPollTimeoutError`
