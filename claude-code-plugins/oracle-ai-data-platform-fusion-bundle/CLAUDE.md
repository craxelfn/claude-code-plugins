...
- **Audit columns are non-negotiable.** Bronze: `_extract_ts`, `_source_pvo`, `_run_id`, `_watermark_used`. Silver: `bronze_extract_ts`, `bronze_source_pvo`, `silver_built_at`. Gold: `gold_built_at`. SOX trail.
